...
import { FacebookIcon, InstagramIcon, TwitterIcon } from '@heroicons/react/outline';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm">
              Vive la experiencia acuática con AQUAZONE. Parques terrestres y flotantes para toda la familia.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <form className="space-y-2">
              ...
              <textarea placeholder="Mensaje" className="w-full p-2 rounded text-gray-900"></textarea>
